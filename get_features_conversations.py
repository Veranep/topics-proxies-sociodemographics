...
if __name__ == "__main__":
    ...
    for model in ["OLMo2", "OLMo3", "Llama", "Gemma"]:
        ...
        for demographic in demographics:
            ...
            accuracies[model][demographic] = accs
            print(model, demographic, np.mean(accs))
            print(all_feature_names[0])
            print(all_feature_names[1])
    with open("data/class_acc_conversations.pkl", "wb") as outfile:
